...
const (
	...
	//RESP_CLIENT_ID CLIENT_ID
	RESP_CLIENT_ID_CMD = "resp_client_id"

	//SEND_TOKEN TOKEN
	SEND_TOKEN_CMD = "send_token"
	//RESP_TOKEN
	RESP_TOKEN_CMD = "resp_token"

	SEND_CHANGE_MESSAGE_SERVER_CMD = "send_change_message_server"

	//SEND_CLIENT_ONLINE_STATUS CLIENT_ID
	SEND_CLIENT_ONLINE_STATUS = "send_client_online_status"
	//RESP_CLIENT_ONLINE_STATUS CLIENT_ID, Alive
	RESP_CLIENT_ONLINE_STATUS = "resp_client_online_status"
	...
	SEND_PUSH_P2P_CMD = "send_push_p2p"
	RESP_PUSH_P2P_CMD = "resp_push_p2p"
	...
	//SEND_INVITE_TOPIC_CMD TOPIC_NAME FRIEND_NAME1...
	SEND_INVITE_TOPIC_CMD = "send_invite_topic"
	//RESP_INVITE_TOPIC_CMD
	RESP_INVITE_TOPIC_CMD = "resp_invite_topic"
	...
	RECEIVE_NOTIFY_TOPIC_CMD  = "receive_notify_topic"
	...
	//FRIENDS_ONLINE_STATUS_CHANGE [{id:1,status :0或1},{id:1,status :0或1}]
	RESP_FRIENDS_STATUS_CHANGE = "resp_friends_status_change"
	// {"cmd":"resp_friends_status_change","obj":["{[{id:1,status :0或1},{id:1,status :0或1}]\}"], "repo":null}

	//SEND_GET_TOKEN RES_TYPE, ACTION_TYPE, _X_
	SEND_GET_TOKEN = "send_get_token"
	//RESP_GET_TOKEN TOKEN FILENAME PATH DOMAIN UPURL
	RESP_GET_TOKEN = "resp_get_token"
)
const (
	SEND_MESSAGE_P2P_CMD_ARGS_NUM           = 2
	SEND_CLIENT_ONLINE_STATUS_ARGS_NUM      = 1
	...
	SEND_INVITE_TOPIC_CMD_ARGS_NUM          = 2
...
const (
	...
	ROUTE_PUSH_P2P_CMD = "route_push_p2p"
