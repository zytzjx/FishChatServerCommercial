...
//---------------------------------------------------------------------------
const (
	TYPE_GATEWAY_SERVER_CMD    = "gateway"
	TYPE_ROUTER_SERVER_CMD     = "router"
	TYPE_MSG_SERVER_SERVER_CMD = "msg_server"
)
...
func NewCmdMonitor(serverType string, time int64, data interface{}) *CmdMonitor {
	return &CmdMonitor{
