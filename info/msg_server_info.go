...
const (
	...
	UNABLE_TO_ACCESS_THE_AUTH_SERVER = "Unable to access the authentication server."
	UNABLE_TO_ACCESS_THE_PUSH_SERVER = "Unable to access the push server."
	PUSH_SERVER_ERROR                = "Push server error:"
	...
	THE_USER_CAN_NOT_BE_FOUND        = "The user can not be found."
	THE_ASK_TYPE_IS_UNDEFINED        = "The ask type is undefined."
	THE_REACT_TYPE_IS_UNDEFINED      = "The react type is undefined."
)
...
const (
	...
	YOU_ARE_ALREADY_IN_THE_TOPIC = "You are already in the topic."
